...
(
    ResepMidwareId	VARCHAR(20) NOT NULL CONSTRAINT APTOL_ResepMidwareItem_ResepMidwareId DEFAULT '',  
    ...
    Signa2 INT NOT NULL CONSTRAINT APTOL_ResepMidwareItem_Signa2 DEFAULT 0, 
