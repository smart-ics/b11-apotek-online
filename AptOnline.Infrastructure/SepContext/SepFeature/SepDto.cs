...
public class SepDto
{
    ...
    public SepType ToSepType()
    {
        ...
        var tipeFaskesPerujuk = new TipeFaskesType(TipeFaskesPerujukId, TipeFaskesPerujukName);
        var faskesPerujuk = new FaskesType(FaskesPerujukId, FaskesPerujukName, tipeFaskesPerujuk);
        var jenisPelayanan = new JenisPelayananType(JenisPelayananId, JenisPelayananName);
        ...
        var result = new SepType(SepId, DateTime.Parse(SepDateTime),
            SepNo, pesertaBpjs.ToRefference(), faskesPerujuk, jenisPelayanan,
            assesmentPelayanan, skdp,
