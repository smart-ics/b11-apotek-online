...
[ApiController]
public class KelasTarifRsController : Controller
{
    private readonly IMediator _mediator;

    public KelasTarifRsController(IMediator mediator)
    {
        _mediator = mediator;
    }
    ...
    {
        var query = new KelasTarifRsGetQuery(id);
    ...
    {
        var query = new KelasTarifRsListQuery();
        var result = await _mediator.Send(query);
        return Ok(new JSendOk(result));
    }
}