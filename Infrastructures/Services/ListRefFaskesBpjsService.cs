...
{
    public interface IListRefFaskesBpjsService
    {
        ListRefFaskesBpjsRespDto Execute(string kodeJnsFaskes, string keyword);
    }
    public class ListRefFaskesBpjsService : IListRefFaskesBpjsService
    {
        private readonly BpjsOptions _opt;
        private readonly string _timestamp;
        private readonly string _signature;
        private readonly string _decryptKey;
        public ListRefFaskesBpjsService(IOptions<BpjsOptions> opt)
        {
            _opt = opt.Value;
        ...
        public ListRefFaskesBpjsRespDto Execute(string kodeJnsFaskes, string keyword)
        {
            var endpoint = $"{_opt.BaseApiUrl}/referensi/ppk/{kodeJnsFaskes}/{keyword}";
